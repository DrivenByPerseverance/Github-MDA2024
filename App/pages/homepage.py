...
path_components = ['App', 'assets', 'data.png']
...
homepage_layout = html.Div([
    ...
    html.Div([
        ...
        # Add image if the base64 encoding was successful
        html.Img(src=f"data:image/png;base64,{base64_encoded_image}", style={'width': '400px', 'display': 'block', 'margin': 'auto'}) if base64_encoded_image else html.Div(),
        html.P(
